...
function Products() {
  ...
  const filterCategories = {
    colors: ['Black', 'Red', 'Blue', 'Yellow', 'Pink', 'White', 'Green', 'Purple'],
    priceRanges: [
    ...
    categories: ['Gaming Keyboards', 'Gaming Mouse', 'Controllers', 'Headsets', 'Monitors', 'Accessories'],
    ...
    <>
      <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
        ...
        <div className="lg:hidden bg-white border-b border-gray-200 p-4">
          <button
            onClick={() => setExpandedCategories(prev => ({ ...prev, mobileMenu: !prev.mobileMenu }))}
        ...
        <div className={`w-full lg:w-80 bg-white shadow-lg border-r border-gray-200 overflow-y-auto ${
          ...
          <div className="p-4 lg:p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  onClick={() => setExpandedCategories(prev => ({ ...prev, mobileMenu: false }))}
          ...
          <div className="p-3 lg:p-4 space-y-4 lg:space-y-6">
            ...
            <div className="border-b border-gray-100 pb-4 lg:pb-6">
              ...
              >
                <h3 className="text-base lg:text-lg font-semibold text-gray-900">Color</h3>
                <svg
                      ...
                      <div className="ml-2 lg:ml-3 flex items-center">
                        <div 
                          ...
                          style={{ backgroundColor: color.toLowerCase() === 'black' ? '#000000' : 
                                  ...
                                  color.toLowerCase() === 'purple' ? '#8b5cf6' : '#6b7280' }}
                        />
                        <span className="text-xs lg:text-sm text-gray-700 group-hover:text-gray-900">{color}</span>
                      </div>
                    </label>
                  ))}
                </div>
            ...
            <div className="border-b border-gray-100 pb-4 lg:pb-6">
              <button
                ...
                className="flex items-center justify-between w-full text-left"
              >
                <h3 className="text-base lg:text-lg font-semibold text-gray-900">Price Range</h3>
                <svg
                  className={`w-4 h-4 lg:w-5 lg:h-5 transform transition-transform ${
                ...
                <div className="mt-3 lg:mt-4 space-y-2 lg:space-y-3">
                  {filterCategories.priceRanges.map((range) => (
                    <label key={range.value} className="flex items-center cursor-pointer group">
                      ...
                      />
                      <span className="ml-2 lg:ml-3 text-xs lg:text-sm text-gray-700 group-hover:text-gray-900">{range.label}</span>
                    </label>
                  ))}
                </div>
              )}
            ...
            <div className="border-b border-gray-100 pb-4 lg:pb-6">
              <button
                ...
                className="flex items-center justify-between w-full text-left"
              >
                <h3 className="text-base lg:text-lg font-semibold text-gray-900">Category</h3>
                <svg
                  className={`w-4 h-4 lg:w-5 lg:h-5 transform transition-transform ${
                  ...
                  {filterCategories.categories.map((category) => (
                    <label key={category} className="flex items-center cursor-pointer group">
                      <input
                        ...
                        className="w-3 h-3 lg:w-4 lg:h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                      />
                      <span className="ml-2 lg:ml-3 text-xs lg:text-sm text-gray-700 group-hover:text-gray-900">{category}</span>
                    </label>
                  ))}
                </div>
              )}
            ...
            <div className="pb-4 lg:pb-6">
              <button
                ...
                className="flex items-center justify-between w-full text-left"
              >
                <h3 className="text-base lg:text-lg font-semibold text-gray-900">Brand</h3>
                <svg
                  className={`w-4 h-4 lg:w-5 lg:h-5 transform transition-transform ${
                  ...
                  {filterCategories.brands.map((brand) => (
                    <label key={brand} className="flex items-center cursor-pointer group">
                      <input
                        ...
                        className="w-3 h-3 lg:w-4 lg:h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                      />
                      <span className="ml-2 lg:ml-3 text-xs lg:text-sm text-gray-700 group-hover:text-gray-900">{brand}</span>
                    </label>
                  ))}
                </div>
              )}
            ...
            {showSearchDropdown && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                <div className="p-3 lg:p-4">
                  <h4 className="text-xs lg:text-sm font-medium text-gray-900 mb-2 lg:mb-3">Suggestions</h4>
                  <div className="space-y-1 lg:space-y-2">
                    {filteredSuggestions.slice(0, 5).map((suggestion, index) => (
                      ...
                      >
                        <svg className="h-3 w-3 lg:h-4 lg:w-4 text-gray-400 mr-2 lg:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                        </svg>
                        {suggestion}
                      </button>
                  ...
                  {searchQuery && filteredSuggestions.length === 0 && (
                    <p className="text-xs lg:text-sm text-gray-500 py-2 lg:py-3">No suggestions found</p>
                  )}
                  
                  <div className="pt-2 lg:pt-3 mt-2 lg:mt-3 border-t border-gray-100">
                    <div className="flex items-center text-xs text-gray-500">
                      <svg className="h-3 w-3 lg:h-4 lg:w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-white rounded-lg shadow-sm">
            <div className="px-4 lg:px-6 py-3 lg:py-4 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                <h2 className="text-xl lg:text-2xl font-bold text-gray-900">Our Products</h2>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 w-full sm:w-auto">
                  <span className="text-xs lg:text-sm text-gray-600">{producte.length} products found</span>
                    ...
                    <div className="p-3 lg:p-4">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 lg:mb-4 gap-2">
                        <div className="flex items-center">
                          <span className="text-lg lg:text-2xl font-bold text-gray-900">₹{product.price}</span>
                          <span className="text-xs lg:text-sm text-gray-500 line-through ml-1 lg:ml-2">₹{parseInt(product.price) + 500}</span>
                        </div>
                        <div className="flex items-center">
                          <div className="flex text-yellow-400">
                            {[...Array(5)].map((_, i) => (
                              <svg key={i} className="w-3 h-3 lg:w-4 lg:h-4 fill-current" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                              </svg>
                            ))}
                          </div>
                          <span className="text-xs lg:text-sm text-gray-600 ml-1">(4.5)</span>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white py-1.5 lg:py-2 px-3 lg:px-4 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm lg:text-base"
                      >
                        View Details
                      </button>
                    </div>
